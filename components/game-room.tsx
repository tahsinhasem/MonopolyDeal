        ...
        <CardContent className="space-y-6">
          ...
          {!isHost && (
            <p className="text-sm text-center text-gray-600">
              Waiting for {players.find((p) => p.isHost)?.displayName} to start
              the game...
            </p>
          )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-xs text-blue-700 text-center">
              <strong>Tip:</strong> If you get disconnected, you can rejoin by
              entering the same name and game code
            </p>
          </div>
        </CardContent>
      </Card>
